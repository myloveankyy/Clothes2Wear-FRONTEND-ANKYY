...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: bHBHAUgVrtBR/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvgIcon
              className={classNames(projectcss.all, sty.svg__b5PJc)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg__twuEb)}
              role={"img"}
            />
          ),
